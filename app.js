...
app.engine(
  "hbs",
  engine({
    extname: ".hbs",    // 확장자로 .hbs 사용
    defaultLayout: "layout",    // 기본 레이아웃 템플릿 지정
    helpers: {  // handlebars 템플릿에서 사용할 수 있는 함수를 정의하는 객체
      section: function (name, options) { // section이라는 함수를 정의
        if (!this._sections) this._sections = {};   // 인자로 섹션이름과 옵션객체를 받음
